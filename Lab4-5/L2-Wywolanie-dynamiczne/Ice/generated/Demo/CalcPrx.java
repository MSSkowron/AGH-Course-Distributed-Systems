...
public interface CalcPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default float avg(long[] n)
        throws NoInput
    {
        return avg(n, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float avg(long[] n, java.util.Map<String, String> context)
        throws NoInput
    {
        try
        {
            return _iceI_avgAsync(n, context, true).waitForResponseOrUserEx();
        }
        catch(NoInput ex)
        {
            throw ex;
    ...
    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(long[] n)
    {
        return _iceI_avgAsync(n, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> avgAsync(long[] n, java.util.Map<String, String> context)
    {
        return _iceI_avgAsync(n, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> _iceI_avgAsync(long[] iceP_n, java.util.Map<String, String> context, boolean sync)
    {
