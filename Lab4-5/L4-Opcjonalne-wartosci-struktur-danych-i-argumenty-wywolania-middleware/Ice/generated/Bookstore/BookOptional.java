...
public class BookOptional extends com.zeroc.Ice.Value
{
    public BookOptional()
    {
        this.title = "";
    ...
    public BookOptional(String title, String author)
    {
        this.title = title;
        this.author = author;
    }

    public BookOptional(String title, String author, int year)
    {
        this.title = title;
        this.author = author;
        setYear(year);
    ...
    public BookOptional clone()
    {
        return (BookOptional)super.clone();
    }

    public static String ice_staticId()
    {
        return "::Bookstore::BookOptional";
    }
    ...
    /** @hidden */
    public static final long serialVersionUID = -2017144771L;
